...
export interface ApiStatusMessageStatusMessage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    app: Attribute.Relation<
      'api::status-message.status-message',
      'oneToOne',
      'api::app.app'
    >;
    hidden: Attribute.Boolean &
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::status-message.status-message': ApiStatusMessageStatusMessage;
